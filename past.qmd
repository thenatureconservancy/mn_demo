...
```{r bps chart, message=FALSE, warning=FALSE, echo=FALSE, fig.width=10, fig.height=9}
library(tidyverse)
library(scales)
library(stringr)
...
```{r fire bar, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=8}
